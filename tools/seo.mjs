...
const paginas = [
  ...
  },
  {
    archivo: "spa.html",
    ruta: "/spa.html",
    // El título lleva la exfoliación por delante a propósito. Es el único
    // tratamiento de este tipo en la zona, así que una búsqueda como
    // "exfoliación Tamarindo" o "body scrub Tamarindo" casi no tiene
    // competencia: quien la hace ya viene decidida, solo falta que encuentre
    // el local. Se nombra el café porque es el material con el que más se la
    // busca, aunque se trabajen seis. "Spa en Tamarindo" se mantiene porque es
    // el término de mayor volumen, y el título queda en 60 caracteres para que
    // Google no lo corte.
    titulo: "Spa en Tamarindo | Exfoliación de Café y Masajes | Odry's",
    descripcion:
      "Exfoliación corporal con café 100% costarricense, lava volcánica, sal "
      + "marina, avena, sábila o frutas. Masajes, manicure y pedicure en gel y "
      + "depilación en Tamarindo, Guanacaste. En el local o a domicilio.",
    imagen: `${SITIO}/assets/images/og-spa.jpg`,
    imagenAlt: "Spa de Odry's en Tamarindo: exfoliación corporal, masajes, manicure y pedicure",
    tipo: "DaySpa",
    // Cada material va como servicio propio en los datos estructurados aunque
    // en el catálogo sean una sola tarjeta: son términos de búsqueda distintos
    // y no compiten entre sí.
    servicios: [
      "Exfoliación corporal", "Exfoliación de café 100% costarricense",
      "Exfoliación de lava volcánica", "Exfoliación de sal marina",
      "Exfoliación de avena", "Exfoliación de sábila",
